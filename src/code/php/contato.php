...
<head>
    ...
    <title>verdeclaro: Contato</title>
    ...
    <section id="maincontent">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="span6">
                    <br>
                    <h4>Sobre verdeclaro</h4>
                    <p>
                        O projeto verdeclaro surgiu como um trabalho de conclusão de curso, dentro da Universidade Federal de Minas Gerais.
                        A motivação veio do interesse na coexistência de agricultura e meio-ambiente, com a tecnologia como apoio. Afinal:
                    </p>
                    <blockquote>
                        <p>
                    ...
                    <label>Status da Nossa Base de Feiras e Produtores</label>
                    <div class="progress progress-striped active">
                        <div class="bar bar-success" style="width: 70%;"></div>
                    </div>
                    <label>Construção do Site</label>
                    <div class="progress progress-striped active">
                        <div class="bar bar-success" style="width: 60%;"></div>
                    </div>
                    <label>Contato com Produtores</label>
                    <div class="progress progress-striped active">
                        <div class="bar bar-success" style="width: 30%;"></div>
                    </div>
                    <h4>Contato</h4>
                    <p>Email: fernandaars@dcc.ufmg.br</p>
                    <br><br><br>
                    <br><br>
                </div>
            </div>
